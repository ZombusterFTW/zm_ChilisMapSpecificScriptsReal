...
function wield_gravityspikes( wpn_gravityspikes ) //self = player
{
	...
	{	
		...
		self thread zm_equipment::show_hint_text( "Press ^3[{+speed_throw}]^7 for Anti-Gravity Trap", N_GRAVITYSPIKE_HINT_TIMER );
...
function gravity_trap_trigger_visibility( player )
{
	...
	{
		self SetHintString( "Hold [{+activate}] to pick up the Ragnarok DG-4" );
		return true;
	}
	else
	{
