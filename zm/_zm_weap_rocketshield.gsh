...
#define ROCKETSHIELD_REFILL_ON_MAX_AMMO 									1
#define ROCKETSHIELD_FLING_DAMAGE_SHIELD									100
#define ROCKETSHIELD_KNOCKDOWN_DAMAGE_SHIELD							15
#define ROCKETSHIELD_JUKE_DAMAGE_SHIELD										0
#define ROCKETSHIELD_FLING_FORCE_JUKE											175
#define ROCKETSHIELD_FLING_RANGE													120
#define ROCKETSHIELD_GIB_RANGE														120
#define ROCKETSHIELD_KNOCKDOWN_RANGE										120
...
#define ROCKETSHIELD_HINT_TEXT 														"Press ^3[{+melee}]^7 to melee\nPress ^3[{+attack}]^7 for rocket boost"
#define ROCKETSHIELD_HINT_TIMER 														5
