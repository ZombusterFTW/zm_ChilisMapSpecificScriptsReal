...
#precache( "triggerstring", "ZOMBIE_POWER_UP_TPAD" );
#precache( "triggerstring", "ZOMBIE_INACTIVE_TPAD" );
#precache( "triggerstring", "ZOMBIE_LINK_TPAD" );

REGISTER_SYSTEM_EX( "zm_giant_teleporter", &__init__, &__main__, undefined )
...
function __main__()
{
	...
	if( !IsSplitscreen() )
	{
		level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_fov;
	}
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_shellshock;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_shellshock_electric;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_bw_vision;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_red_vision;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_flashy_vision;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = &zm_giant_teleporter::teleport_aftereffect_flare_vision;
}
...
function sndCountdown()
{
	...
	// level thread zm_giant::sndPA_DoVox( "vox_maxis_teleporter_ultimatum_0" );
	...
	while ( count > 0 )
	{
		...
		if ( play )
		{
			// level thread zm_giant::sndPA_DoVox( "vox_maxis_teleporter_count_" + num, undefined, true );
			num--;
		}
	...
	// level thread zm_giant::sndPA_DoVox( "vox_maxis_teleporter_expired_0" );
}
...
function player_teleporting( index )
{
	...
	// level thread zm_giant::sndPA_DoVox( "vox_maxis_teleporter_success_0" );
