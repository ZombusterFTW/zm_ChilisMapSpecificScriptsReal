...
function blundersplat_missile_sound_and_fx_loop( n_local_client_num )
{
	...
	self thread blundersplat_sound_fuse_loop();
...
function blundersplat_sound_fuse_loop()
{
	soundLoopEmitter( "wpn_blundersplat_proj_loop", self.origin );
	self waittill( "entityshutdown" );
	soundStopLoopEmitter( "wpn_blundersplat_proj_loop", self.origin );
}
