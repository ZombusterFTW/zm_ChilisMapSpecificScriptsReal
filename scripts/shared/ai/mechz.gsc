...
function autoexec init()
{
	...
	clientfield::register( "actor", "mechz_faceplate_detached", VERSION_DLC1, 2, "int" );
	clientfield::register( "actor", "mechz_powercap_detached", VERSION_DLC1, 1, "int" );
	clientfield::register( "actor", "mechz_claw_detached", VERSION_DLC1, 2, "int" );
...
function mechz_track_powercap_damage( damage )
{
	...
	if( self.powercap_health <=0 )
	{
		...
		self clientfield::set( "mechz_claw_detached", ( self.classname == "actor_spawner_zm_tomb_mechz" ? 2 : 1 ) );
