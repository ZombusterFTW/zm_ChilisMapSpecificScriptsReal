...
function __init__()
{
	...
	foreach(trig in jump_pad_triggers)
	{
		trig SetHintString("");
		trig SetCursorHint("HINT_NOICON");
	}
	level waittill("playercoveredinoil");
	level jump_pad_init(jump_pad_triggers);
}

function jump_pad_init(jump_pad_triggers)
{
	//jump_pad_triggers = GetEntArray( "trig_jump_pad", "targetname" );
	//jump_pad_triggers SetCursorHint("HINT_NOICON");
	//jump_pad_triggers SetHintString("Oil is required to fly. Dumbass");
